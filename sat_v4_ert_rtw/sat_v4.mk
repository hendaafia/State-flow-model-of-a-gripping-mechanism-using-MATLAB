###########################################################################
## Makefile generated for Simulink model 'sat_v4'. 
## 
## Makefile     : sat_v4.mk
## Generated on : Sun Jan 09 11:53:58 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sat_v4.elf
...
PRODUCT_NAME              = sat_v4
MAKEFILE                  = sat_v4.mk
MATLAB_ROOT               = C:/PROGRA~1/Polyspace/R2020a
MATLAB_BIN                = C:/PROGRA~1/Polyspace/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Sr2 S1/Hyprid/Project/V6
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/henda/DOCUME~1/MATLAB/R2020a/ArduinoStaticLibrary/ArduinoMega2560/FasterRuns
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sat_v4.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/toolbox/target/supportpackages/arduinobase/include -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/toolbox/target/shared/svd/include -I$(START_DIR)/sat_v4_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/toolbox/target/supportpackages/arduinotarget/include -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/toolbox/target/shared/externalmode_daemon/include -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/3P.instrset/arduinoide.instrset/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/utility -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/SPI/src -IC:/PROGRA~3/MATLAB/SupportPackages/R2020a/3P.instrset/arduinoide.instrset/libraries/Servo/src/avr
...
DEFINES_ = -DMODEL=sat_v4 -DNUMST=4 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=65411 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=1
...
DEFINES_STANDARD = -DMODEL=sat_v4 -DNUMST=4 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_ServoWriteRead.o MW_AnalogInput.o ArduinoPinHandleMap.o sat_v4.o sat_v4_data.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/sat_v4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/sat_v4_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/sat_v4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ServoWriteRead.o : C:/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/target/supportpackages/arduinobase/src/MW_ServoWriteRead.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/sat_v4_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sat_v4.o : $(START_DIR)/sat_v4_ert_rtw/sat_v4.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sat_v4_data.o : $(START_DIR)/sat_v4_ert_rtw/sat_v4_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
