...
#ifndef typedef_cell_Project_T
#define typedef_cell_Project_T

typedef struct tag_GtaT2TPu8wQVLKHBwLo3ME cell_Project_T;

#endif                                 /*typedef_cell_Project_T*/
...
{
  cell_Project_T AvailablePwmPinNames;
};
...
typedef struct tag_mpp1zrYKkiJ3gUUTqSUOmD codertarget_arduinobase_int_o_T;

#endif                               /*typedef_codertarget_arduinobase_int_o_T*/

/* Parameters (default storage) */
typedef struct P_Project_T_ P_Project_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Project_T RT_MODEL_Project_T;

#endif                                 /* RTW_HEADER_Project_types_h_ */
