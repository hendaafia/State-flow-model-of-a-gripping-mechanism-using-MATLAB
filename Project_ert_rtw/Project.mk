...
## 
## Makefile     : Project.mk
## Generated on : Thu Dec 30 13:59:16 2021
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Project.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/University/Fall 2022/Hybrid control/project
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/verin/DOCUME~1/MATLAB/R2020a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Project.elf
...
DEFINES_ = -DMODEL=Project -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=25 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=1
...
OBJS = MW_ServoWriteRead.o MW_arduino_digitalio.o MW_AnalogInput.o ArduinoPinHandleMap.o Project.o Project_data.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.S.o : $(START_DIR)/Project_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Project.o : $(START_DIR)/Project_ert_rtw/Project.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Project_data.o : $(START_DIR)/Project_ert_rtw/Project_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Project_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
